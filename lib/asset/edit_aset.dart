...
import 'package:skripsi_rania/asset/details_page.dart';

// ignore: must_be_immutable
class EditAset extends StatefulWidget {
  //const EditAset({ Key? key }) : super(key: key);
...
class _EditAsetState extends State<EditAset> {
  ...
  void isiform() {
    _namaAset.text = widget.items['namak'];
    _masaAset.text = widget.items['masa'];
    _picAset.text = widget.items['pic'];
    _emailAset.text = widget.items['email'];
    _telpAset.text = widget.items['nomor'];
    _jabatanAset.text = widget.items['jabatan'];
    _todoDateController.text = widget.items['tanggal'];
    _hargaAset.text = widget.items['harga'];
    _jenisAset.text = widget.items['jenis'];
  foto1 = widget.items['gambark'];
  foto2 = widget.items['gambarb'];
  dropdownValue = widget.items['jenis'];
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: DropdownButton<String>(
                          ...
                          //hint: Text(widget.items[_jenisAset])
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: InkWell(
                    ...
                    child:
                     _image == null
                         ?  Image.network(foto1, fit: BoxFit.cover,)
                        : Image.file(
                            _image!,
                            fit: BoxFit.cover,
                          ),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: InkWell(
                    ...
                    child:
                     _image2 == null
                         ?  Image.network(foto2, fit: BoxFit.cover,)
                        : Image.file(
                            _image2!,
                            fit: BoxFit.cover,
                          ),
  ...
  void _validasi1(context) {
    showDialog(
        ...
        builder: (BuildContext context) => AlertDialog(
              ...
              content: const Text(
                "Apakah data aset yang anda edit sudah sesuai? ",
                style: TextStyle(fontFamily: "NunitoSans"),
              ),
              actions: <Widget>[
                TextButton(
                ...
                TextButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
                            builder: (context) => PageDetail(widget.items, 'asset')),
                      );
                    },
                    child: const Text('OK',
                        style: TextStyle(
